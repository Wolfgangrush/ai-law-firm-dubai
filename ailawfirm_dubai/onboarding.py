...
Usage:
    python3 -m ailawfirm_dubai.onboarding
    or: ailawfirm-dubai init
"""

from pathlib import Path
from ailawfirm_dubai.entity_registry import EntityRegistry
from ailawfirm_dubai.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from ailawfirm_dubai.entity_registry import COMMON_ENGLISH_WORDS
...
def _generate_alias_bootstrap(
    ...
    registry_lines = [
        "# entity-aliasing Entity Registry",
        "# Auto-generated by ailawfirm-dubai init. Update as needed.",
        "",
        "## People",
    ]
    for p in people:
    ...
    (mempalace_dir / "alias_entities.md").write_text("\n".join(registry_lines))
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.ailawfirm-dubai/alias_entities.md")
    print("  Critical facts bootstrap: ~/.ailawfirm-dubai/critical_facts.md")
