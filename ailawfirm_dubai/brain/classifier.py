...
_RULES: list[tuple[list[str], Intent]] = [
    ...
    (
        [
            "court", "jurisdiction", "bench", "tribunal", "difc court",
            "dubai court", "rental disputes", "court of first instance",
            "court of appeal", "cassation", " mahkama", "محكمة",
        ],
        Intent.COURT_QUERY,
    ),
    (
        ["draft", "drafting", "statement of claim", "defence", "defense",
         "reply", "rejoinder", "affidavit", "plaint", "written statement"],
        Intent.DRAFTING_NEED,
    ),
    (
        ["deadline", "limitation", "due date", "hearing date", "next date",
         "limitation period", "filing deadline"],
        Intent.DEADLINE_CHECK,
    ),
    (
        ["client said", "client called", "client wants", "client emailed",
         "client confirmed"],
        Intent.CLIENT_COMM,
    ),
    (
    ...
    (
        ["dpl", "difc data", "uae dpp", "data protection", "data breach",
         "goaml", "aml", "clpd", "publicity", "solicit", "advertis",
         "data subject", "kyc", "money laundering", "license renewal",
         "cpe", "conflict of interest", "confidential"],
        Intent.COMPLIANCE_FLAG,
    ),
    (
        ["switch to difc", "switch to mainland", "switch system",
         "change system", "use difc", "use mainland"],
